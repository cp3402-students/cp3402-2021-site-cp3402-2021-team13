    ...
    <header id="masthead" class="site-header">
        <div class="site-branding">
            ...
            <nav id="site-navigation" class="main-navigation">
                ...
                /* The below code checks if a mobile-menu is set from the backend in the menu settings.
                If a menu has been set it will be displayed in the header. Or else, a menu has not been set then
                display a message.*/
